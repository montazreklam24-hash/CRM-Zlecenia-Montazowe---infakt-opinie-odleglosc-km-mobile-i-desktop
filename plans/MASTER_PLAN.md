...
### 1.4 Sortowanie "DO PRZYGOTOWANIA"
...
### 2.2 Odświeżanie LIVE (Dashboard & Map)
...
### 2.3 Wartość Zlecenia (Orientacyjna vs Potwierdzona)
...
### 2.4 Import Maili (Automatyzacja)
...
### 4.1 Karta Zlecenia na Mobile
*   **Problem:** Obecnie widoczny tylko nagłówek.
*   **Zadanie:** Dodanie brakujących sekcji (Adres, Opis, Notatki, Checklista). Usprawnienie galerii zdjęć.
