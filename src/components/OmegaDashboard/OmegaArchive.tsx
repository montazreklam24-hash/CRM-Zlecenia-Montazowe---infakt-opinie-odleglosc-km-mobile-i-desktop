...
import { 
  Archive, Image as ImageIcon, ThumbsUp, ThumbsDown, Trash2 
} from 'lucide-react';
import PaymentStatusBadge, { PaymentStatusMiniMenu } from '../PaymentStatusBadge';

interface OmegaArchiveProps {
  filteredJobs: Job[];
...
const OmegaArchive: React.FC<OmegaArchiveProps> = ({
